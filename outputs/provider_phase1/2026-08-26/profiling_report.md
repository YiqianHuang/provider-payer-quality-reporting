...
- Catalog release date(s): `2026-08-13`
- Datasets: `6`
- Source rows across files: `94,062`
- Raw CSV bytes: `23,273,953`
...
|---|---:|---:|---|---:|---:|---:|
| `4gkm-5ypv` | 784 | 14 | State + Measure ID + Start Date + End Date | 0 | 3,568 | 108 |
| `632h-zaca` | 67,060 | 20 | Facility ID + Measure ID + Start Date + End Date | 0 | 293,567 | 35,796 |
| `9n3s-kdb3` | 18,330 | 12 | Facility ID + Measure Name + Start Date + End Date | 0 | 40,211 | 6,987 |
| `cvcs-xecj` | 14 | 14 | Measure ID + Start Date + End Date | 0 | 65 | 1 |
| `xubh-q36u` | 5,419 | 38 | Facility ID | 0 | 27,581 | 2,568 |
